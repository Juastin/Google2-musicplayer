...
public class Muziek {
    ...
    public Muziek(Integer[] melody) throws InterruptedException, IOException,NullPointerException {
...
//            System.out.println("Melodie is:"+ noot);
    ...
    public void speelaf(Integer[] welknummer) throws InterruptedException, IOException,NullPointerException {
